...
/*
 * James Nail 5/30/2013:
 * This file originally came from NuGet package adjunct-JetBrains.Annotations.Core, v1.0.0.
 * Its intent is to give us the ability to use JetBrains' ReSharper annotations without 
 * referencing its assembly everywhere.
 * The code in this file was also modified (mostly making "internal" things public) to make it more useful.
 */
...
namespace ConfigCentral 
{
    ...
    public sealed class AssertionConditionAttribute : Attribute
    {
        ...
        {
            _myConditionType = conditionType;
        }
    ...
    ///     Using "halt" (or "void"/"nothing", which is the same) for method output means that method doesn't return normally.
    ///     <br />
    ...
    /// <summary>
    ///     This attribute is intended to mark API used only via reflection and should not be removed and so is treated as
    ///     used.
    /// </summary>
    [MeansImplicitUse]
